...
myBot.on('message', data => {
    ...
    if (data.content.startsWith(prefix + 'demande')){
        ...
        if(data.content.startsWith(prefix + 'demanderaid')) {
            ...
            var mess = hook(data.channel,'__**' + hookArgs[0] + '**__', hookArgs[1] + '\n' + '➖➖➖➖➖➖\n' + '**Décollage : ** \n' + hookArgs[2] + '\n' + '➖➖➖➖➖➖\n', 'Demande faite par ' + data.author.username, ListToString([data.author.username]), "", "https://cdn.discordapp.com/attachments/739532179943719014/855861859490857000/mini-logo-echo.png")
            data.channel.send(mess);
    }}})
